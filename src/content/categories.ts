...
export const categories: Category[] = [
  ...
  {
    id: 'vibecode',
    title: 'Вайб-кодинг на практике',
    icon: '🚀',
    description:
      'Термины трека «от идеи до продукта»: MVP, требования, критерии приёмки, откат через git, минимальные права, техдолг, инциденты.',
  },
  {
    id: 'qa-pro',
    title: 'QA: профессия глубже',
    icon: '🐞',
    description:
      'Термины трека про профессию тестировщика: риск-ориентированность, таблица решений, тест-стратегия, shift-left.',
  },
]
